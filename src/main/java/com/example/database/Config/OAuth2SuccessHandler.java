...
////        OAuth2AuthenticationToken token = (OAuth2AuthenticationToken) authentication;  //token given by google
////        OAuth2User oAuth2User = token.getPrincipal();
////
////        String registrationId = token.getAuthorizedClientRegistrationId(); //this is basically used to get to know if the authentication came from google facebook or github any for that matter
